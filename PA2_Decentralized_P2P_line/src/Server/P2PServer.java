...
public class P2PServer implements Runnable
{
	...
	public static ConcurrentHashMap<String, ArrayList<Socket>> linearSocketMapping
	= new ConcurrentHashMap<>();
	
	
	public static String PATH_OF_FILE = "E:/Java/Workspace/PA2_Decentralized_P2P_line/p2pSharedFolder/";
	...
	public static void query(String messageID, String fileName, int TTL) throws IOException 
	{
		while(TTL!= 0)
		{
			searchLinearTopology(fileName, linearSocketMapping);
			TTL--;
		}
	}
	
	public static List<String> searchLinearTopology(String fileName, 
			ConcurrentHashMap<String, ArrayList<Socket>> linearSocketMapping2)
			throws IOException
	{
		List <String> filePeers = new ArrayList<String>();
		
		for (int i=0;i<linearSocketMapping2.size();i++)
		{
			ArrayList<Socket> linearSock = linearSocketMapping2.get(Integer.toString(i));
			
			filePeers = distributedHashTable.get(fileName);	
			//get the Value(s) i.e location, for the Key(Filename)
		}
		return filePeers;
	}
	...
	/*
	 * regsiter function implementation
	 */
